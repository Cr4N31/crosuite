    ...
    <main className="bg-[#07070f] text-white min-h-screen relative">
      ...
      >
        ...
        <div className="relative z-10 max-w-2xl mx-auto">
          <span className="inline-block text-[0.6rem] tracking-[5px] uppercase text-white/50 border border-white/20 px-4 py-1.5 rounded-sm mb-8">
            Transparency
          </span>
      ...
      <section className="py-20 px-6 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start" data-aos="fade-up">
        <div>
          <p className="text-[0.6rem] tracking-[5px] uppercase text-white/50 mb-2">Fund Allocation</p>
