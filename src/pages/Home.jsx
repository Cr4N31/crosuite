  ...
  return (
    <main className="bg-black text-white relative">
      ...
      >
        ...
        <div className="bg-blue-900/90 border border-white/[0.06] rounded-xl p-6 text-sm font-mono">
        ...
        <div className="flex gap-3">
            ...
            <div className="border border-white/[0.06] rounded-lg p-4 bg-blue-950/60">
                ...
                {[
                    ...
                    <div key={item.label}>
                    <p className="text-white/70 text-[10px] font-sans uppercase font-bold tracking-widest mb-0.5">{item.label}</p>
                    <p className="text-white/50 text-xs font-sans">{item.value}</p>
                    </div>
                ))}
                </div>
                ...
                <button className="w-full py-2 rounded-sm bg-blue-700 border border-blue-800/40 text-white text-xs font-sans tracking-wide hover:bg-blue-700/60 transition-all duration-200">
                Join Airdrop
                </button>
            </div>
            </div>
      ...
      <section className="py-24 px-6" data-aos="fade-up">
        <div className="bg-blue-900/90 border border-white/[0.06] rounded-xl p-6 text-sm font-mono mt-4">
        <p className="text-white/15 text-xs tracking-widest uppercase mb-5"># general</p>
        ...
        <div className="flex gap-3">
            ...
            <div className="flex-1">
            <p className="text-blue-200/80 text-xs font-sans mb-1">User</p>
            <p className="text-white/80 text-xs mb-3">/Mybalance</p>

            <div className="border border-white/[0.06] rounded-lg p-4 bg-blue-950/60">
                <p className="text-white text-xs font-sans font-semibold mb-4">Your Balances</p>
                ...
                {[
                    ...
                    <span className="text-violet-100 text-[11px] font-sans w-16">{item.token}</span>
                    <span className="text-white/50 text-[11px] font-sans flex-1">{item.amount}</span>
                    <span className="text-white/50 text-[11px] font-sans">{item.usd}</span>
                    </div>
                ))}
                </div>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-white/60 text-[10px] font-sans uppercase tracking-widest">Total Portfolio Value</span>
                    <span className="text-white/60 text-xs font-sans">$0.00</span>
                </div>
                </div>

                <p className="text-white/50 text-[10px] font-sans mb-3 break-all">
                Wallet: 0x8Fb57a133ab7eFd600CFA173e406e74D2d7C14d2
                </p>

                <div className="flex items-center justify-between">
                <p className="text-white/30 text-[10px] font-sans">Today at 8:56 AM · Only you can see this</p>
                <button className="text-white/20 text-[10px] font-sans hover:text-white/30 transition-colors">Dismiss</button>
                </div>
            </div>
            </div>
        </div>
