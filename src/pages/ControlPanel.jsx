...
function ControlPanel() {
  return (
    <main className="bg-black/20 text-white min-h-screen">
      ...
      {/* Page Hero */}
      <section className="relative pt-36 pb-16 px-6 text-center" style={{ backgroundImage: `url('${bg}')`, backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <section className="py-12 px-6 max-w-4xl mx-auto border-t border-white/5">
        <h3 className="font-syne font-bold text-lg text-white mb-6">ℹ️ Notes</h3>
        <ul className="flex flex-col gap-3">
          {[
            ...
            <li key={note} className="flex items-start gap-3 text-sm text-[#9990b0]">
